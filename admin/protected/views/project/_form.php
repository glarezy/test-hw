...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<span><?php echo CHtml::encode(Yii::t('project','uploadtip'));?></span>
	</div>
	...
	<div id="uploadFlag" class="row parthidden" style="clear:both;">
...
<div class="parthidden">
	...
	<div id="uploadUrl"><?php echo Helper::resUrl('/project/uploadpic');?></div>
