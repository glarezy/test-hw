...
$(document).ready(function() {
	$('#btnFormSubmit2').live('click', function(){
		if( $('#uploadingTip').html() ) {
			alert($('#uploadingSubmitDeny').html());
			return;
		}
		if( $('#titVal').val() == '' ) {
			alert($('#titleWarn').html());
			return;
		}
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'title',array('id'=>'titVal', 'size'=>60,'maxlength'=>255)); ?>
	...
	<div class="row">
		...
		<input type=button id=btnUpload value="<?php echo Yii::t('download','uploadfile');?>">
	</div>
	...
	<div class="row buttons">
		<?php echo CHtml::button($model->isNewRecord ? Yii::t('common','create') : Yii::t('common','save'),array('id'=>'btnFormSubmit2')); ?>
	</div>
...
<div class="parthidden">
	...
	<div id="titleWarn"><?php echo Yii::t('download','titleWarn');?></div>
