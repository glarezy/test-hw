<?php
	$howToBuy = Yii::app()->language == 'zh_cn' ? 'images/buy-zh.png' : 'images/buy-en.png';
?>
...
<table width="944" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="226"><?php echo H::img('productbannera.jpg',226,182);?></td>
		<td>
			...
			<table width="92%" border="0" cellpadding="0" cellspacing="0">
              	<tr>
                	<td height="40" align="left" valign="top">
                		<ul class="title"><li><?php echo H::m('title-icon.jpg',23,26);?></li><li><?php echo CHtml::encode($this->action->id == 'buy' ? Yii::t('buy','title') : Yii::t('product','product'));?></li></ul>
                	</td>
				</tr>
            </table>
			...
			<table width="224" height="380" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td align="center" valign="top" bgcolor="EDEDED"  >
						...
						<table width="190" border="0" cellpadding="0" cellspacing="0">
									<tr>
        								<td align=center height=100><?php echo CHtml::link(CHtml::image(Helper::resUrl($howToBuy),''),array('how_to_buy'));?></td>
      								</tr>
    							</table>
					</td>
				</tr>
