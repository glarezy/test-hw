    							...
    							<ul>
      								<table width="190" border="0" cellpadding="0" cellspacing="0">
        								...
        								<tr>
											...
											<?php if( $subtype == 'question' ) echo CHtml::image(Helper::resUrl('images/arrowblue.jpg'),'',array('width'=>4,'height'=>7));?>
          									</td>
          									<td width="166" height="22" align="left">
          										<?php echo CHtml::link($subentry['label'],$subentry['link'],array('class'=>$subtype == 'question'?'link_blues':'link_blue'));?>
          									</td>
        								</tr>
	        							<?php } ?>
       								</table>
