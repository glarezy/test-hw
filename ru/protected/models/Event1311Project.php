...
/**
 * This is the model class for table "event_1311_project".
 *
 * The followings are the available columns in table 'event_1311_project':
 * @property integer $id
 ...
 */
class Event1311Project extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('ptime, subject, content, htmlhead, type, title', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'ptime' => Yii::t('project', 'ptime'),
			'title' => Yii::t('project', 'title'),
			'subject' => Yii::t('project', 'subject'),
			'content' => Yii::t('project', 'content'),
			'recommend' => Yii::t('project', 'recommend'),
			'htmlhead' => Yii::t('project', 'seo'),
			'ctime' => Yii::t('project', 'ctime'),
			'mtime' => Yii::t('project', 'mtime'),
		);
	}
	 ...
	 * @return Event1311Project the static model class
	 */
