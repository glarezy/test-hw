		...
		<td width="270" style="vertical-align:top;word-break:break-all;">
			...
			if( isset($newproduct[0]) ) {
				...
				<div style="width:258px; height:108px; margin-top:4px;vertical-align:middle; background:url(images/text_bg.jpg); background-repeat:no-repeat;">
					<?php
					$msg1 = '<div style="color:#333;word-wrap:break-word; font-weight:bold;padding:0 10px; line-height:110%;">'.CHtml::encode($productTitle[$newproduct[0]->rid]).'</div>';
					$msg2 = '<div style=" margin-top:5px; color:#333;word-break:normal;padding:0 8px; line-height:120%;">'.CHtml::encode($productDesp[$newproduct[0]->rid]).'</div>';
