...
<table width="944" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td><?php echo H::img($bannerImage,943,182);?></td>
	</tr>
</table>
<br>
        								...
        								<tr>
											...
											<?php if( $subtype == $type ) echo CHtml::image(Helper::resUrl('images/arrowblue.jpg'),'',array('width'=>4,'height'=>7));?>
          									...
          									<td width="166" height="22" align="left">
          										<?php
          										if(isset($subentry['target']) && $subentry['target']!='')
          										echo CHtml::link($subentry['label'],$subentry['link'],array('target'=>$subentry['target'],'class'=>$subtype == $type?'link_blues':'link_blue'));
          										else
          										echo CHtml::link($subentry['label'],$subentry['link'],array('class'=>$subtype == $type?'link_blues':'link_blue'));?>
          									</td>
        								</tr>
	        							<?php } ?>
       								</table>
