...
<table width="944" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td><?php echo H::img('servicebanner.jpg',943,182);?></td>
	</tr>
</table>
<br>
			...
			<table width="92%" border="0" cellpadding="0" cellspacing="0">
				<tr>
                	<td height="40" align="left" valign="top">
                		<ul class="title"><li><?php echo H::m('title-icon.jpg',23,26);?></li><li><?php echo $typename!='' ? CHtml::encode($typename) : CHtml::encode(Yii::t('project','project'));?></li></ul>
                	</td>
                </tr>
            </table>
